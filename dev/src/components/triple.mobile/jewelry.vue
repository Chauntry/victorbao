   ...
   <div class="content" id="dior-mobile">
    ...
    <div v-if= "!searchMsg" id="wrapper" class="page-home-news" data-page="home-news" data-track-univers="CDC" data-track-page="PDG">
      <div class="padded-content border-bottom">
        ...
        <!-- START New Campaigns -->
        <a v-for="item in recom" class="new-campaign" href="#/catalog.mobile/{{item.id}}">
    ...
    <div class="gamme-grid" :style="searchMsg ? '' : {'margin-top': '3rem'}">
      ...
      <ul data-category="Rose_des_vents" class="js-category">
        <li v-for="item in searchItems">
          <a href="#/catalog.mobile/{{item.id}}" class="packshot">
          <img :src="item.photos[0]"/></a>
          <div>
           <a href="#/catalog.mobile/{{item.id}}">
    ...
    <div id="ecrin-footer" data-role="footer" class="ecrin-global ecrin-white-footer">
     ...
     <div id="ecrin-footer-wrapper" class="border-top">
       <a href="#/catalog.mobile" class="ecrin-footer-buttons">Contact</a>
     </div>
     ...
     <div id="ecrin-footer-links">
      <nav>
       <ul>
        <li> <a href="#/catalog.mobile">Boutiques</a></li>
        <li> <a href="#/catalog.mobile">Contact</a></li>
        <li><a href="#/catalog.mobile">My Account</a></li>
       </ul>
       <ul>
        <li> <a href="#/catalog.mobile">Legal Terms</a></li>
        <li> <a href="#/catalog.mobile">Personal Data</a></li>
        <li> <a href="#/catalog.mobile">CAREERS</a></li>
       </ul>
      </nav>
     </div>
    </div>
