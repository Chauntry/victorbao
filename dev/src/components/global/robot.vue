<template lang="html">
<div class="ground">
  <div class = "titile"> My dream to become a robot engineer</div>
  <div class = "buttonClip">
    <div class= "group" v-for = "button in controlList" @click="pressButton($index)">
      <div class="grid-button">
          <span class="grid {{button.value}}"></span>
      </div>
      <div class="description"> {{button.des}}</div>
    </div>
  </div>
  <svg id="robot" class = "robot" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="8rem" height="7.5rem" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
      ...
      C118.309,65.694,118.625,47.035,112.809,28.372z" @click="pressButton(0)"/>
          <g>
              <g id="eyeLeft">
      ...
      <g id="upperTorso">
          <g id="leftArm" @click = "pressButton(1)">
              <g class="forearm">
      ...
      c-3.827,5.537-6.726,10.938-8.8,16.387c0,0-1.877,4.187,2.599,6.24C16.75,139.75,18.917,135.142,18.917,135.142z" />
          ...
          <g id="rightArm" @click = "pressButton(2)">
              <g class="forearm">
      ...
      c-3.552,13.081-5.232,26.162-5.184,39.242L125.283,131.334z" @click="pressButton(0)"/>
      </g>
      <g id="lowerTrunk">
          <g id="leftFoot" @click = "pressButton(3)">
        ...
        c0,3.526,2.859,6.386,6.386,6.386c3.526,0,6.385-2.859,6.385-6.386L61.27,200.63L61.27,200.63L61.27,200.63z" />
          ...
          <g id="rightFoot" @click = "pressButton(4)">
        ...
        c0,3.526-2.859,6.386-6.387,6.386c-3.525,0-6.385-2.859-6.385-6.386V200.63L98.73,200.63L98.73,200.63z" />
          ...
          <path fill="#f7727a" d="M34.719,131.334c0.048,13.082,1.824,26.164,5.184,39.246H80h40.098c3.361-13.08,5.138-26.162,5.186-39.244L34.719,131.334z" @click="pressButton(0)"/>
      </g>
  </svg>
</div>
</template>
...
export default {
  ...
  data() {
    return {
      controlList: [
        {obj: 'robot', value: 'close', des: 'shaking'},
        {obj: 'leftArm', value: 'close', des: 'leftArm'},
        {obj: 'rightArm', value: 'close', des: 'rightArm'},
        {obj: 'leftFoot', value: 'close', des: 'leftFoot'},
        {obj: 'rightFoot', value: 'close', des: 'rightFoot'}
      ],
    }
  },
  props: {
  ...
  methods: {
    ...
    pressButton (index) {
      if (this.controlList[index].value == 'close') {
        this.controlList[index].value = 'open'
        $('#' + this.controlList[index].obj + '-stop')[0].id = this.controlList[index].obj
      }
      else {
        this.controlList[index].value = 'close'
        $('#' + this.controlList[index].obj)[0].id = this.controlList[index].obj + '-stop'
      }
    }
  },
  ...
  ready () {
    ...
    $('#robot')[0].id = 'robot-stop';
    $('#leftArm')[0].id =  'leftArm-stop';
    $('#rightArm')[0].id = 'rightArm-stop';
    $('#leftFoot')[0].id = 'leftFoot-stop';
    $('#rightFoot')[0].id = 'rightFoot-stop';
